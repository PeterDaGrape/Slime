...
class Renderer: NSObject, MTKViewDelegate {
    ...
    init(_ parent: MetalView, agentData: AgentData, species: [SIMD3<Float>]) {
        ...
        for i in 0...numberAgents - 1 {
            ...
            let agent: Agent = Agent(position: vector_float2(centeredPosition), angle: angle, index: Int32(i), velocity: 1)
    ...
    func draw(in view: MTKView) {
        ...
        let frameTexture = metalDevice.makeTexture(descriptor: textureDescriptor)
        ...
        let newFrameTexture = metalDevice.makeTexture(descriptor: textureDescriptor)
